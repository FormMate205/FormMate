...
const RepaymentMethodSelector = ({
    ...
    return (
        <div className='flex w-screen gap-4 my-4 rounded-lg'>
                ...
                >
                    ...
                    <div className='flex w-full gap-4'>
                        <CommonModal
                            triggerChildren={
                                <div
                                    className='border-primary-500 text-primary-500 rounded-[4px] border bg-white px-3 py-2 text-sm font-medium whitespace-nowrap'
